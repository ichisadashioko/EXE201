...
namespace PWA_tinder_for_pets.Migrations
{
    ...
    [Migration("20250926092453_GoogleGeminiGenImageWIP2")]
    partial class GoogleGeminiGenImageWIP2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shioko.Models.ImageDataMimeCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Shioko.Models.User", b =>
                {
                    ...
                    b.Property<int?>("ProfileUserImageId")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("ProfileUserImageId");
            ...
            modelBuilder.Entity("Shioko.Models.User", b =>
                {
                    b.HasOne("Shioko.Models.UserImage", "ProfileUserImage")
                        .WithMany()
                        .HasForeignKey("ProfileUserImageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ProfileUserImage");
                });
